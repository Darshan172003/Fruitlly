  ...
  return (
    <div className="mb-12 md:mb-14">
      ...
      <h1 className="mt-4 text-text-dark text-4xl md:text-5xl lg:text-6xl font-black leading-tight tracking-tight">
        ...
        <span className="block bg-linear-to-r from-primary to-accent-green bg-clip-text text-transparent">Confectionery Supply Chain</span>
      </h1>
      <p className="text-gray-600 text-lg leading-relaxed max-w-2xl mt-4">
        Connect with Tulsi Foods for bulk jelly products, private labeling, and large-scale manufacturing inquiries.
      </p>
    </div>
  );
};
